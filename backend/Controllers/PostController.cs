...
namespace backend.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        {
            if (request.Access == null || string.IsNullOrEmpty(request.RecipientId) || (string.IsNullOrEmpty(request.Text) && request.File == null)) return BadRequest("Data in null or empty");
